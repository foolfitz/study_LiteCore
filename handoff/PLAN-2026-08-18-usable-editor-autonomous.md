...
> **狀態（2026-08-19 補記）：五項裡四項做完。** T0／T1（判準）／T2／T3a 在 08-18；
> **T3b、T3c、T4 在 08-19**。剩下 **T1.3（059 的引擎修法）**——判準決定了，但欠一個
> 真的負向臂，而且要連結。這一輪的結果寫在
> [`HANDOFF-2026-08-19-every-row-has-a-check.md`](HANDOFF-2026-08-19-every-row-has-a-check.md)
> （英文，08-19 起交接文件改用英文）。T4 的三條事前預測有一條錯了兩個量級，
> 見 finding 062 的〈事前預測與實際的差距〉。
