#!/usr/bin/env python3
"""Assemble the isolated Finding 016 verified-selection delete profile."""
...
def build_profile(
    ...
    manifest["profile"] = "finding-016-selection-barrier"
    manifest["sdkVersion"] = (
        f'{manifest["sdkVersion"]}+finding-016-selection-barrier'
    )
    ...
    manifest["capabilities"] = [
        ...
        if capability in retained_capabilities
    ] + [
    ...
    manifest["diagnostic"] = {
        ...
        "experiment": "finding-016-selection-barrier",
        "contract": "verified-single-writer-unit-selection-v1-not-product-abi",
